...
import {
  Anchor, History, User, RefreshCw, Settings, Bell, Shield, Users, Database, Clock, CheckCircle2, AlertTriangle, Handshake, ChevronDown, ClipboardCheck, MapPin, Users as UsersIcon, ArrowLeft, MessageSquare, Package, Gauge, FileText } from 'lucide-vue-next';
...
import { SITE_CHECKIN_STATUS_LABELS, SITE_CHECKIN_STATUS_COLORS, ABNORMAL_CATEGORY_LABELS, type SiteCheckinActionLog } from '../../types';
...
const actionLogs = computed(() =>
 siteCheckinStore.getLogsByCheckinId(checkinId.value).sort((a, b) => new Date(b.timestamp).getTime() - new Date(a.timestamp).getTime()),
);
